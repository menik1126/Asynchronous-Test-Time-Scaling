...
class ServerArgs:
    ...
    def __post_init__(self):
        if self.inference_model == "draft":
            if not self.draft_model_path:
                raise ValueError(
                    "draft_model_path must be set when inference_model is 'draft'."
                )
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            help="The path of the draft model weights for inference_model=draft. This can be a local folder or a Hugging Face repo ID.",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            default=ServerArgs.inference_model,
            help="Choose whether the server runs inference using the target or draft model.",
        )
