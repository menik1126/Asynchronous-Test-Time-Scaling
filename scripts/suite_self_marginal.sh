...
OUTPUT_DIR="${PROJECT_DIR}/results/self_prefill_${model_short}_${DATASET_NAME}_sm${MAX_TOKENS}_t${TURNS}_temp${TEMPERATURE}"
mkdir -p "$OUTPUT_DIR"

echo "===================================================================================="
echo "ATTS Self-Evaluation (Marginal Coverage)"
...
echo ""
echo "[Step 3/3] Running self-async evaluation (prefill PPL, prefix-cache friendly)..."
no_proxy="localhost,127.0.0.1,0.0.0.0" NO_PROXY="localhost,127.0.0.1,0.0.0.0" \
    ...
    --output_dir "$OUTPUT_DIR" 2>&1 | tee "$OUTPUT_DIR/async_self.log"
...
echo ""
echo "===================================================================================="
echo "Self-evaluation test completed!"
