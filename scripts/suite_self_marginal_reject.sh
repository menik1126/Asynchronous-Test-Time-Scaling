...
# Reuse PPL array from the prefill version if it exists, otherwise compute it
...
OUTPUT_DIR="${PROJECT_DIR}/results/self_reject_${model_short}_${DATASET_NAME}_sm${MAX_TOKENS}_t${TURNS}_temp${TEMPERATURE}_thr${PPL_THRESHOLD}_att${MAX_REJECT_ATTEMPTS}"
mkdir -p "$OUTPUT_DIR"

echo "===================================================================================="
echo "ATTS Self-Evaluation (TRUE Rejection Sampling)"
...
echo ""
echo "[Step 3/3] Running self-async evaluation (TRUE rejection sampling)..."
...
echo ""
echo "===================================================================================="
echo "Rejection sampling test completed!"
