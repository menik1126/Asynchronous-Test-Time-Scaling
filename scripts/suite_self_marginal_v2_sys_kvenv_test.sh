...
OUTPUT_DIR="${PROJECT_DIR}/results/self_prefill_v2sys_kvenv_nocompress_${model_short}_${DATASET_NAME}_sm${MAX_TOKENS}_t${TURNS}_temp${TEMPERATURE}"
mkdir -p "$OUTPUT_DIR"

echo "===================================================================================="
echo "ATTS Self-Evaluation (Marginal Coverage) — KV-Env No-Compress Test"
