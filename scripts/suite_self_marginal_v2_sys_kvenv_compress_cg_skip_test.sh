...
OUTPUT_DIR="${PROJECT_DIR}/results/self_prefill_v2sys_kvenv_compress_cg_skip_${model_short}_${DATASET_NAME}_sm${MAX_TOKENS}_t${TURNS}_temp${TEMPERATURE}_b${KV_COMPRESS_BUDGET}_r${KV_COMPRESS_RATIO}"
mkdir -p "$OUTPUT_DIR"
