...
OUTPUT_DIR="${PROJECT_DIR}/results/self_reject_fork_v2sys_${model_short}_${DATASET_NAME}_sm${MAX_TOKENS}_t${TURNS}_temp${TEMPERATURE}_thr${PPL_THRESHOLD}_att${MAX_REJECT_ATTEMPTS}_a${ALPHA}"
mkdir -p "$OUTPUT_DIR"
