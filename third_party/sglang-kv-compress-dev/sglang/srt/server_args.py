...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--enable-kv-compress",
            action="store_true",
            help="Enable SnapKV-style KV cache compression after prefill",
        )
        parser.add_argument(
            "--kv-compress-budget",
            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            default=ServerArgs.kv_compress_recent_window,
            help="Number of recent tokens to always keep",
        )
        parser.add_argument(
            "--kv-compress-obs-window",
            type=int,
        ...
        parser.add_argument(
            ...
            type=int,
            default=ServerArgs.kv_compress_min_seq_len,
            help="Minimum sequence length to trigger compression",
        )
