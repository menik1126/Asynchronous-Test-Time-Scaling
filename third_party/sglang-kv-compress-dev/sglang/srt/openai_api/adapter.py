    ...
    for request in all_requests:
        ...
        if not isinstance(request.messages, str):
            ...
            if chat_template_name is None:
                ...
                # Record question/template length before appending assistant content
                _snapkv_protect_len = len(prompt_ids)
        ...
        # Pass question/template token length for SnapKV prefix protection
        if '_snapkv_protect_len' in dir():
            sampling_params["custom_params"] = sampling_params.get("custom_params") or {}
            if isinstance(sampling_params["custom_params"], dict):
                sampling_params["custom_params"]["snapkv_protect_len"] = _snapkv_protect_len
            del _snapkv_protect_len
