...
class ForwardBatch:
    ...
    def init_new(
        ...
        if (
            ...
            ret.snapkv_cache_q_layer_ids = set(range(start_layer, total_layers))
            ret.snapkv_obs_window = model_runner.server_args.kv_compress_obs_window
        else:
            ret.snapkv_cache_q_layer_ids = None
            ret.snapkv_obs_window = 0
