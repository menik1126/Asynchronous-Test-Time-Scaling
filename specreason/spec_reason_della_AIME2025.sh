...
THRESHOLD=3 #9
NUM_REPEATS=16 #1 #16
BASE_MODEL_NAME="Qwen/QwQ-32B-renew" #"Skywork/Skywork-OR1-32B" #"simplescaling/s1.1-32B" #"Qwen/QwQ-32B"  # "Qwen/QwQ-32B" or "deepseek-ai/DeepSeek-R1-Distill-Llama-70B" or "NovaSky-AI/Sky-T1-32B-Preview"
SMALL_MODEL_NAME="meta-llama/Llama-3.1-8B-Instruct-renew" #"Skywork/Skywork-OR1-7B" #"simplescaling/s1.1-7B" #"deepseek-ai/DeepSeek-R1-Distill-Llama-8B" #"meta-llama/Llama-3.1-8B-Instruct" #"Qwen/Qwen2.5-7B-Instruct" 
export SGLANG_PORT_32B=40000
export SGLANG_PORT_1_5B=40001
#"deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"  # "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B" or "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
...
ids1=($(seq 0 14))  # AIME 2025 (30 problems total, IDs 0-29)
