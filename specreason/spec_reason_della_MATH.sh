#!/bin/bash
#SBATCH --job-name=specr_math_32b_greedy9          # Job name
...
THRESHOLD=3 #9
NUM_REPEATS=16 #1 #16
BASE_MODEL_NAME="simplescaling/s1.1-32B" #"Qwen/QwQ-32B"  # "Qwen/QwQ-32B" or "deepseek-ai/DeepSeek-R1-Distill-Llama-70B" or "NovaSky-AI/Sky-T1-32B-Preview"
SMALL_MODEL_NAME="simplescaling/s1.1-7B" #"deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"  # "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B" or "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
...
ENGINE_LOG_DIR="${LOGFILE_DIR}/${ENGINE}/${JUDGE_SCHEME}_${THRESHOLD}_sample_${NUM_REPEATS}/${DATASET_NAME}/${BASE_MODEL_NAME}_${SMALL_MODEL_NAME}"
...
for id in "${ids1[@]}"; do
    ...
    logfile="${ENGINE_LOG_DIR}/${timestamp}.log"
